...
class RethinkDBHook(AbstractHook):
    ...
    def __init__(self, output_dir: str, credentials_file: str, table: str, config_file: str='config.yaml', **kwargs):
        """
        ...
        rethink_id_file = path.join(output_dir, 'rethink_key.json')
